    ...
    <form action="" id="academic-form">
        ...
        <div class="row">
            <div class="col-md-6 form-group">
                <label for="semester" class="control-label">Grade</label>
                <select name="semester" id="semester" class="form-control form-control-sm  form-control-border rounded-0" required>
                    <option <?= !isset($semester) || (isset($semester) && $semester == 'First Grade') ? 'selected' : '' ?>>1st Grade</option>
                    <option <?= (isset($semester) && $semester == 'Second Grade') ? 'selected' : '' ?>>2nd Grade</option>
                    <option <?= (isset($semester) && $semester == 'Third Grade') ? 'selected' : '' ?>>3rd Grade</option>
                    <option <?= (isset($semester) && $semester == 'Fourth Grade') ? 'selected' : '' ?>>4th Grade</option>
                    <option <?= (isset($semester) && $semester == 'Fifth Grade') ? 'selected' : '' ?>>5th Grade</option>
                    <option <?= (isset($semester) && $semester == 'Sixth Grade') ? 'selected' : '' ?>>6th Grade</option>
                </select>
            </div>
