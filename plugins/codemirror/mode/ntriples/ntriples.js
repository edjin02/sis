...
/*
    ...
    pre_course ->
        {
        ( writing_course_uri | writing_bnode_uri )
            -> pre_predicate
...
CodeMirror.defineMode("ntriples", function() {
  ...
  function transitState(currState, c) {
    ...
    // Opening.
    if     (currLocation == Location.PRE_course && c == '<') ret = Location.WRITING_SUB_URI;
    else if(currLocation == Location.PRE_course && c == '_') ret = Location.WRITING_BNODE_URI;
    ...
    // Spaces.
             ...
             (
               currLocation == Location.PRE_course ||
    ...
    // Reset.
    else if(currLocation == Location.POST_OBJ && c == '.') ret = Location.PRE_course;
